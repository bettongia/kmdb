...
void main() {
  ...
  group('Encryption provisioning crash-safety (FaultyStorageAdapter)', () {
    test('crash before any fsync: reopen sees a clean plaintext DB (re-provision safe)', () async {
      ...
      await db.close(flush: false); // close without flush to leave WAL unsynced
      faultyAdapter.crash();
