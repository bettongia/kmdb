...
void main() {
  ...
  group('StaleIndexException', () {
    ...
    test('is an Exception', () {
      expect(
        const StaleIndexException(namespace: 'ns', path: 'p', status: 'stale'),
        isA<Exception>(),
      );
    });
  });
  ...
  group('ReservedIndexPathException', () {
    ...
    test('is an Exception', () {
      expect(const ReservedIndexPathException('ns', '_p'), isA<Exception>());
    });
  });
  ...
  group('SchemaValidationException', () {
    ...
    test('is an Exception', () {
      expect(
        SchemaValidationException(collection: 'ns', violations: const []),
        isA<Exception>(),
      );
    });
  });
