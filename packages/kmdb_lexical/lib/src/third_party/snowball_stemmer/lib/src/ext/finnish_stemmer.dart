...
class finnish_stemmer extends BaseStemmer {
  ...
  late final List<Among> a_3 = [Among('lle', -1, -1), Among('ine', -1, -1)];
  ...
  late final List<Among> a_8 = [Among('i', -1, -1), Among('j', -1, -1)];

  late final List<Among> a_9 = [Among('mma', -1, 1), Among('imma', 0, -1)];

  static final List<int> g_AEI = [
    17,
    1,
    0,
    0,
  ...
  static final List<int> g_particle_end = [
    17,
    97,
    24,
    1,
