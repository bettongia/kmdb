...
@internal
final Map<String, RegistryEntry> mimeinfoDbFont = {
  ...
  "font/otf": const RegistryEntry(
    ...
    magic: [
      Magic(
        priority: 50,
        matches: [
          Match(type: MatchType.string, offset: '0', value: 'OTTO', mask: null),
        ],
      ),
    ],
  ),
  "font/ttf": const RegistryEntry(
    ...
    magic: [
      Magic(
        priority: 50,
        matches: [
          Match(type: MatchType.string, offset: '0', value: 'FFIL', mask: null),
          Match(
