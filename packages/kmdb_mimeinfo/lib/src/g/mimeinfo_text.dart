...
@internal
final Map<String, RegistryEntry> mimeinfoDbText = {
  ...
  "text/x-microdvd": const RegistryEntry(
    ...
    magic: [
      Magic(
        priority: 50,
        matches: [
          Match(type: MatchType.string, offset: '0', value: '{1}', mask: null),
          Match(type: MatchType.string, offset: '0', value: '{0}', mask: null),
          Match(type: MatchType.string, offset: '0:6', value: '}{', mask: null),
        ],
      ),
    ],
  ),
  ...
  "text/spreadsheet": const RegistryEntry(
    ...
    magic: [
      Magic(
        priority: 50,
        matches: [
          Match(type: MatchType.string, offset: '0', value: 'ID;', mask: null),
        ],
      ),
    ],
  ),
  ...
  "text/x-emacs-lisp": const RegistryEntry(
    ...
    magic: [
      Magic(
        priority: 50,
        matches: [
          Match(type: MatchType.string, offset: '0', value: '\n(', mask: null),
          Match(
            type: MatchType.string,
            offset: '0',
    ...
    magic: [
      Magic(
        ...
        matches: [
          ...
          Match(type: MatchType.string, offset: '0', value: '<h1', mask: null),
          Match(type: MatchType.string, offset: '0', value: '<H1', mask: null),
          Match(
            type: MatchType.string,
            offset: '0',
  ...
  "text/x-component": const RegistryEntry(
    ...
    rootXML: [RootXML(namespaceURI: 'urn:HTMLComponent', localName: 'PUBLIC')],
  ),
  ...
  "text/x-todo-txt": const RegistryEntry(
    ...
    magic: [
      Magic(
        priority: 10,
        matches: [
          Match(type: MatchType.string, offset: '0', value: '(A) ', mask: null),
          Match(type: MatchType.string, offset: '0', value: 'x ', mask: null),
        ],
      ),
    ],
  ),
    ...
    magic: [
      Magic(
        ...
        matches: [
          ...
          Match(type: MatchType.string, offset: '0', value: 'REM', mask: null),
        ],
      ),
    ],
  ),
