...
doc_site_html: $(SITE_DIR)/favicon.ico $(SITE_DIR)/bettongia-$(DOCS_DIR).css $(SITE_DIR)/index.html $(SITE_DIR)/guide.html $(SITE_DIR)/user_guide.html $(SITE_DIR)/spec.html $(SITE_DIR)/roadmap.html $(SITE_DIR)/api.html $(SITE_DIR)/api-docs
.PHONY: doc_site_html
...
# The CLI/User Guide is likewise a single, self-contained document
# (docs/user_guide/README.md). Its data/ fixtures and sync_copy.* scripts are
# demo material for the guide's worked examples, not part of the published page.
$(SITE_DIR)/user_guide.html: $(DOCS_DIR)/user_guide/README.md $(DOCS_DIR)/.pandoc $(_HEADER) | $(SITE_DIR)
	pandoc --defaults="$(DOCS_DIR)/.pandoc" $(DOCS_DIR)/user_guide/README.md -o "$(SITE_DIR)/user_guide.html";
