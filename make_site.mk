...
doc_site_html: $(SITE_DIR)/favicon.ico $(SITE_DIR)/bettongia-$(DOCS_DIR).css $(SITE_DIR)/index.html $(SITE_DIR)/spec.html $(SITE_DIR)/roadmap.html $(SITE_DIR)/api.html $(SITE_DIR)/api-docs
.PHONY: doc_site_html
